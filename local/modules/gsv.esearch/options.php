<?php
    ...
    $module_id = gsv_esearch::MODULE_STATIC_ID;
    ...
    $extourRight = $APPLICATION->GetGroupRight($module_id);
    if ($extourRight>="R") :

        $aTabs = array();

        $aTabs[] = array("DIV" => "edit1", "TAB" => Loc::getMessage('OPT_GSV_ESEARCH_TAB'), "ICON" => "seo_settings", "TITLE" => Loc::getMessage('OPT_GSV_ESEARCH_TAB'));
        ...
        $arOptions = Array(
            ...
            "edit1" => Array(
                "esearch_url" => Array("esearch_url", Loc::getMessage('OPT_GSV_ESEARCH_ESEARCH_URL'), array("text"), $gsv_esearch_default_option["esearch_url"]),
                "http_auth" => Array("http_auth", Loc::getMessage('OPT_GSV_ESEARCH_HTTP_AUTH'), array("text"), $gsv_esearch_default_option["http_auth"]),
                "product_iblock_id" => Array("product_iblock_id", Loc::getMessage('OPT_GSV_ESEARCH_PRODUCT_IBLOCK_ID'), array("select", $arIblocks), $gsv_esearch_default_option["product_iblock_id"]),
                "offers_iblock_id" => Array("offers_iblock_id", Loc::getMessage('OPT_GSV_ESEARCH_OFFERS_IBLOCK_ID'), array("select", $arIblocks), $gsv_esearch_default_option["offers_iblock_id"]),
                "brand_iblock_id" => Array("brand_iblock_id", Loc::getMessage('OPT_GSV_ESEARCH_BRAND_IBLOCK_ID'), array("select", $arIblocks), $gsv_esearch_default_option["brand_iblock_id"]),
            ),
