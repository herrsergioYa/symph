<?
    ...
    class local_lib extends \CModule
    {
        ...
        const MODULE_STATIC_ID = "local.lib";
        ...
        function __construct()
        {
            ...
            $this->MODULE_NAME = GetMessage("local_lib_MODULE_NAME");
            $this->MODULE_DESCRIPTION = GetMessage("local_lib_MODULE_DESC");
        ...
        function GetModuleRightList()
        {
            $arr = array(
                ...
                "reference" => array(
                    "[D] ".Loc::getMessage("local_lib_DENIED"),
                    "[R] ".Loc::getMessage("local_lib_OPENED"),
                    "[W] ".Loc::getMessage("local_lib_FULL"))
            );
            return $arr;
        }
    }