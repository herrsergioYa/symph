...
namespace Gsv\Sale\Delivery\Restrictions;
...
//TODO: It is RAW!!
class PropertyRestriction extends Restrictions\Base
{
    ...
    public static function check($result, array $restrictionParams, $deliveryId = 0)
    {
