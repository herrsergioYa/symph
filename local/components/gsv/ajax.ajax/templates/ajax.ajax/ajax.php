...
//$componentName = dirname(__DIR__);
//if(basename($componentName) == 'templates') {
//    //We are in the component's folder?
//    $componentName = dirname($componentName);
//}
//$componentName = basename(dirname($componentName)) . ':' . basename($componentName);
//$templateName = basename(__DIR__);

$componentName = "gsv:ajax.ajax";
$templateName = '.default';

$componentSalt = "$componentName-$templateName";
...
if(isset($params['COMPONENT_TEMPLATE']) && $params['COMPONENT_TEMPLATE'] != $templateName)
{
    $APPLICATION->RestartBuffer();
    http_response_code(400);
    die();
...
//$templateName = $params['COMPONENT_TEMPLATE'] ?: $templateName;
