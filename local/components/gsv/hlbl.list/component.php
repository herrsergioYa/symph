...
$arParams["HLBL_ID"] = trim($arParams["HLBL_ID"]);
...
//	}
	...
	{
		$arItem = $obElement->collectValues();

		if($arParams['DETAIL_URL'])
        {
            $arItem['DETAIL_PAGE_URL'] = $arParams['DETAIL_URL'];
            $arItem['DETAIL_PAGE_URL'] = str_replace('#HLBL_ID#', $arParams['HLBL_ID'], $arItem['DETAIL_PAGE_URL']);
            $arItem['DETAIL_PAGE_URL'] = str_replace('#ELEMENT_ID#', $arItem['ID'], $arItem['DETAIL_PAGE_URL']);
            if($arParams['CODE_FIELD'])
            {
                $arItem['DETAIL_PAGE_URL'] = str_replace('#ELEMENT_CODE#', $arItem[$arParams['CODE_FIELD']], $arItem['DETAIL_PAGE_URL']);
            }
        }
        ...
        if($arParams['LIST_URL'])
        {
            ...
            $arItem['LIST_PAGE_URL'] = str_replace('#HLBL_ID#', $arParams['HLBL_ID'], $arItem['LIST_PAGE_URL']);
            $arItem['LIST_PAGE_URL'] = str_replace('#ELEMENT_ID#', $arItem['ID'], $arItem['LIST_PAGE_URL'] );
            if($arParams['CODE_FIELD'])
            {
                $arItem['LIST_PAGE_URL'] = str_replace('#ELEMENT_CODE#', $arItem[$arParams['CODE_FIELD']], $arItem['LIST_PAGE_URL']);
            }
        }
...
//		}
	...
	$arResult['HLBL_ID'] = $arParams['HLBL_ID'];
